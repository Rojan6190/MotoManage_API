"""
Django settings for MotoManage project.
...
CORS_ALLOW_ALL_ORIGINS = True  #For development only, this allows flutter to talk to django
ROOT_URLCONF = "MotoManage.urls"
...
WSGI_APPLICATION = "MotoManage.wsgi.application"
